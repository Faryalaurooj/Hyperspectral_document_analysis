...
# different wavelengths in single 2d plot
...
if img is not None:
 ...
 # Set the x-axis ticks to show specific mean wavelength values
   # mean_wavelengths = [400, 500, 600, 700, 800, 900]
   # plt.xticks(mean_wavelengths, mean_wavelengths)

   # Set the x-axis limits to show the full range of 400 to 900
   # plt.xlim([400, 900])
